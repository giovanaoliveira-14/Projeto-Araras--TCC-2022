...
-- Copiando dados para a tabela banco_araras.cadastro_usuario_vaga: 4 rows
...
-- Copiando dados para a tabela banco_araras.curriculos: 9 rows
...
INSERT INTO `empresa_simples` (`id_emp`, `id_tipo_doc_emp`, `numero_doc_emp`, `cei_emp`, `razao_emp`, `nome_fantasia_emp`, `ramo_emp`, `rua_emp`, `numero_end_emp`, `complemento_emp`, `cep_emp`, `bairro_emp`, `cidade_emp`, `estado_emp`, `pais_emp`, `id_responsavel_emp`) VALUES
	...
	(12, 1, '123456789', '123456789', 'Empresa', 'Empresa', 'Empresa', 'rua', 123, 'casa', 213546, 'bairro', 'marilia', 'estado', 'paises', 5),
...
-- Copiando dados para a tabela banco_araras.imagens_vagas: 6 rows
...
-- Copiando dados para a tabela banco_araras.usuario_simples: 17 rows
...
INSERT INTO `usuario_simples` (`id_usu`, `nome_usu`, `nome_social_usu`, `nacionalidade_usu`, `data_nascimento_usu`, `id_tipo_doc_usu`, `identidade_usu`, `telefone_usu`, `celular_usu`, `email_usu`, `senha_usu`, `rua_usu`, `numero_casa_usu`, `complemento_usu`, `cep_usu`, `bairro_usu`, `cidade_usu`, `estado_usu`, `pais_usu`, `id_sexo_usu`, `id_etnia_usu`, `id_formacao_usu`, `id_visto_usu`, `descricao_visto_usu`, `id_deficiencia_usu`, `interesse_prof_usu`, `sobre_usu`) VALUES
	(1, 'Giovana', '0', 'Brasileira', '2022-11-16', 1, '1234568', '1498156355', '14981563565', 'teste@teste.com', 'abc123456', 'aaaaaa', 15, 'aaaa', 12345697, 'aaaaa', 'aaaaaa', 'aaaaa', 'aaaaa', 1, 1, 1, 1, 'aaaaaaa', 1, 'aaaaaaa', 'aaaaaa'),
	(2, 'aaaaaaaaaa', '0', 'aaaaaaaaaa', '2022-11-11', 1, '1265656', '1234567890', '12345678951', 'teste@teste.com ', 'aaaaaaaaaa555555', 'aaaaaaaaaaa', 123456, 'aaaaa', 125464, 'aaaaaa', 'aaaaa', 'aaaaa', 'aaaaaa', 1, 1, 1, 1, 'aaaaaa', 4, 'aaaaaaa', 'aaaaaaaaaaa'),
	(3, 'Giovana', '0', 'Brasileira', '2022-11-06', 1, '123456789', '14253614', '1425361425', 'teste@teste.com ', 'gilinda123456', 'aaaaaaaa', 123654, 'aaaaaaaaa', 123654, 'aaaaaaa', 'aaaaaaaaa', 'aaaaaaaaaaa', 'aaaaaaa', 1, 1, 10, 1, 'aaaaaaaaaa', 5, 'teste', 'aaaaaaaaaaaa'),
	(4, 'teste', '0', 'teste', '2022-11-24', 1, '6565655', '6565655', '32323232', 'teste@teste.com ', 'aaa5555', 'aaaaaaa', 55555445, 'aaaaaaaaa', 4554544, 'aaaaaaa', 'aaaaa', 'aaaaaaaa', 'aaaaaaaaaaa', 1, 2, 9, 1, 'aaaaaaaaa', 6, 'aaaaaaaaaaaa', 'aaaaaaaaaaa'),
	(5, 'teste', '0', 'teste', '2022-11-24', 1, '6565655', '6565655', '32323232', 'teste@teste.com ', 'aaaaaaaaaaaaaaa', 'aaaaaaa', 55555445, 'aaaaaaaaa', 4554544, 'aaaaaaa', 'aaaaa', 'aaaaaaaa', 'aaaaaaaaaaa', 1, 2, 9, 1, 'aaaaaaaaa', 6, 'aaaaaaaaaaaa', 'aaaaaaaaaaa'),
	(6, 'teste', '0', 'teste', '2022-11-24', 1, '6565655', '6565655', '32323232', 'teste@teste.com ', 'aaaaaaaa', 'aaaaaaa', 55555445, 'aaaaaaaaa', 4554544, 'aaaaaaa', 'aaaaa', 'aaaaaaaa', 'aaaaaaaaaaa', 1, 2, 9, 1, 'aaaaaaaaa', 6, 'aaaaaaaaaaaa', 'aaaaaaaaaaa'),
	(7, 'teste', '0', 'teste', '2022-11-24', 1, '6565655', '6565655', '32323232', 'teste@teste.com ', 'aaaaaaaaaaa', 'aaaaaaa', 55555445, 'aaaaaaaaa', 4554544, 'aaaaaaa', 'aaaaa', 'aaaaaaaa', 'aaaaaaaaaaa', 1, 2, 9, 1, 'aaaaaaaaa', 6, 'aaaaaaaaaaaa', 'aaaaaaaaaaa'),
	(8, 'teste', '0', 'teste', '2022-11-24', 1, '6565655', '6565655', '32323232', 'teste@teste.com ', 'aaaaa', 'aaaaaaa', 55555445, 'aaaaaaaaa', 4554544, 'aaaaaaa', 'aaaaa', 'aaaaaaaa', 'aaaaaaaaaaa', 1, 2, 9, 1, 'aaaaaaaaa', 6, 'aaaaaaaaaaaa', 'aaaaaaaaaaa'),
	(9, 'teste', '0', 'teste', '2022-11-24', 1, '6565655', '6565655', '32323232', 'teste@teste.com ', 'aaaaaa', 'aaaaaaa', 55555445, 'aaaaaaaaa', 4554544, 'aaaaaaa', 'aaaaa', 'aaaaaaaa', 'aaaaaaaaaaa', 1, 2, 9, 1, 'aaaaaaaaa', 6, 'aaaaaaaaaaaa', 'aaaaaaaaaaa'),
	(10, 'Leticia', '0', 'Brasileira', '2022-11-21', 1, '123456789', '123456789', '123456789', 'teste@teste.com ', 'teste123456', 'teste', 123456, 'aaaaa', 123456, 'teste', 'aaaa', 'aaaaa', 'aaaaa', 1, 2, 8, 1, 'aaaaaa', 5, 'Teste', 'Teste'),
	(11, 'Leticia', '0', 'Brasileira', '2022-11-21', 1, '123456789', '123456789', '123456789', 'teste@teste.com ', 'aaaaa', 'teste', 123456, 'aaaaa', 123456, 'teste', 'aaaa', 'aaaaa', 'aaaaa', 1, 2, 8, 1, 'aaaaaa', 5, 'Teste', 'Teste'),
	(12, 'Teste', '', 'Teste', '2022-11-05', 2, '1234567', '142583617', '14253617', 'teste@teste.com ', 'teste1245', 'teste', 21465454, 'teste', 3563564, 'testet', 'teste', 'teste', 'teste', 2, 2, 9, 1, 'teste', 5, 'Teste', 'Teste'),
	(13, 'Amanda', 'Carol', 'Brasileira', '2022-11-10', 2, '123456789', '1425361425', '12345687995', 'teste@teste.com ', '827ccb0eea8a706c4c34a16891f84e7b', 'aaaaaa', 12365, 'aaaaaaaa', 445554, 'aaaaaaaaaaa', 'aaaaaaaaa', 'aaaaaaaa', 'aaaaaaaaa', 1, 1, 8, 1, 'aaaaaaaaaa', 4, 'teste', 'teste'),
	(14, 'Giovana', 'Carol', 'Brasileira', '2022-11-04', 1, '1265656', '3543543544', '544445', 'teste@teste.com ', 'b6a615cbb437caa5a0cc0ff2d833eb3a', 'aaaaaaa', 35566, 'aaaaaaaaa', 66556565, 'aaaaaaa', 'aaaaa', 'aaaaaaaa', 'aaaaaa', 1, 4, 8, 1, 'aaaaaaaaa', 7, 'teste', 'ghghgh'),
	(15, 'Giovana', '', 'Brasileira', '2022-11-04', 1, '1265656', '3543543544', '544445', 'teste@teste.com ', '2ee4ff62edbd401d13a4a3507ecab8e6', 'aaaaaaa', 35566, 'aaaaaaaaa', 66556565, 'aaaaaaa', 'aaaaa', 'aaaaaaaa', 'aaaaaa', 1, 4, 8, 1, 'aaaaaaaaa', 7, 'teste', 'ghghgh'),
	(16, 'Giovana Oliveira', 'Gigi Furac̣o', 'Do munḍo', '2004-08-14', 1, '123456789', '142536523', '233652325', 'giovana@giovana.com ', 'e10adc3949ba59abbe56e057f20f883e', 'Fim do Mundo', 666, 'Casa torta', 666999777, 'Parque do Penhasco', 'Onde judas perdeu as botas', 'Depressivo', 'Terra Plana', 1, 2, 11, 1, 'Vista grossa', 2, 'Que pague bem', 'A ṃe ̩ d++'),
	(17, 'Giovana dos Santos Oliveira', '', 'Brasileira', '2004-08-14', 2, '1234698752', '14253623165', '14253614256', 'giovana@giovana.com ', '123654', 'Antonio Burac̣o', 666, 'Casita Madrigal', 156236523, 'Fim do mundo', 'Uc do mundo', 'Depressivo', 'Brasil sil sil', 1, 2, 8, 2, '', 7, 'Programadora', '');
...
-- Copiando dados para a tabela banco_araras.vagas: 17 rows
